...
import {
    ...
    useIncomingCall
} from 'features/calls/providers/IncomingCallProvider';
import { useUnreadCount } from 'features/notifications/hooks/useUnreadCount';
import { SocketEffects } from '../providers/AppProviders';
...
// Component to wire up SocketEffects with IncomingCallProvider
const RouterEffects: React.FC = () => {
    const { showIncomingCall } = useIncomingCall();
    return <SocketEffects showIncomingCall={showIncomingCall} />;
};
